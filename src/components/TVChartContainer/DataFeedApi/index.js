...
export default {
	...
	getBars: function(symbolInfo, resolution, from, to, onHistoryCallback, onErrorCallback, firstDataRequest) {
		...
		historyProvider.getBars(symbolInfo, baseItem, counterItem, resolution, from, to, firstDataRequest, 200)
		.then(bars => {
			if (bars.length) {
